...
import { addToConversationHistory } from "../agents/SupervisorAgent";
...
export async function handleUserQuery(
  ...
  // Save user message to conversation history for context
  ...
  addToConversationHistory(sessionId, "assistant", answer.substring(0, 500));

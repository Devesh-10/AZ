        ...
        <div className="form-side">
          <div className="form-wrapper">
            ...
            <p className="powered-by">
              Powered by Claude AI for intelligent sustainability insights
            </p>
          </div>
        </div>
        ...
        <div className="branding-side">
          <div className="branding-content">
            ...
            <h1 className="hero-title">
              ...
              <span className="title-line-2">Insight Agent</span>
            </h1>

            <p className="hero-description">
              Transform sustainability data into actionable insights. Track energy consumption,
              monitor GHG emissions, analyze water usage, and accelerate EV transition with
            ...
            <div className="feature-list">
              <div className="feature-item">
                ...
                <span>Real-time sustainability KPI monitoring across sites</span>
              </div>
              <div className="feature-item">
                <div className="feature-check">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
              ...
              <div className="feature-item">
                ...
                <span>ESG reporting and carbon footprint analysis</span>
              </div>
            </div>

...
export class SiaLanggraphStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const backendLambda = new lambda.Function(this, "SiaBackendHandler", {
      ...
      description: "SIA LangGraph Backend - Sustainability Insight Agent",
    });
    ...
    const api = new apigateway.RestApi(this, "SiaApi", {
      restApiName: "SIA LangGraph API",
      description: "Sustainability Insight Agent API",
    ...
    const frontendBucket = new s3.Bucket(this, "SiaFrontendBucket", {
      bucketName: `sia-langgraph-frontend-${this.account}`,
    ...
    const distribution = new cloudfront.Distribution(
      this,
      "SiaFrontendDistribution",
      {
        comment: "SIA LangGraph Frontend",
        defaultBehavior: {

          ...
          <div className="form-wrapper">
            <div className="form-card">
              <div className="form-header">
                ...
                <h2>Welcome Back</h2>
                <p>Sign in to the Enterprise Data Office</p>
              </div>
            ...
            <p className="powered-by">
              Powered by Claude AI on AWS Bedrock
            </p>
          </div>
        </div>
        ...
        <div className="branding-side">
          <div className="branding-content">
            ...
            <h1 className="hero-title">
              <span className="title-line-1">Enterprise Data</span>
              <span className="title-line-2">Office Automation</span>
            </h1>

            <p className="hero-description">
              A multi-agent operating model that orchestrates Governance, Data Quality,
              Master Data and AI Consumption end-to-end — powered by Claude AI
              on AWS Bedrock.
            </p>
            ...
            <div className="feature-list">
              <div className="feature-item">
                ...
                <span>Data Governance, Quality, Management & Consumption agents</span>
              </div>
              <div className="feature-item">
                <div className="feature-check">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
              ...
              <div className="feature-item">
                ...
                <span>Automated profiling, rule validation, and remediation guidance</span>
              </div>
            </div>
